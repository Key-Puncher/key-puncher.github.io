...
This e-portfolio requires a minimum number of 12 posts (but more content is welcome) of no less than 250 words for each post.

1. A revised CV demonstrating development from work placement experience.
2. A logbook of placement hours and activities (the activity/achievement log template provided will assist in tracking this content)
3. Minimum of 5 posts critically reflecting on your own performance and professional/personal development through the placement (e.g. highlights, challenging times, surprising insights, interesting developments, etc.)
4. Minimum of 5 posts on experience you have gained through your placement using the STAR framework covering the topics outlined in the work placement preparation module (e.g. leadership, teamwork, initiative, problem solving, negotiating conflict, communication, etc.).
This is a reflective e-portfolio, and so you must use it to demonstrate your work placement in terms of professional development. While there are no hard and fast rules about how to do this, the following chapters may give you some framework for these posts.
